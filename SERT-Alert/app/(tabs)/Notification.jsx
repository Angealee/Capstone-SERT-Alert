...
const Notification = () => {
  ...
  const fetchNotifications = async () => {
    ...
    try {
      ...
      const apiUrl = "https://sertwebapp-c0hrepa2d9a7afem.southeastasia-01.azurewebsites.net/api/GetReportList"; // API URL: https://sertwebapp-c0hrepa2d9a7afem.southeastasia-01.azurewebsites.net/api/GetReportList sample: https://jsonplaceholder.typicode.com/posts
